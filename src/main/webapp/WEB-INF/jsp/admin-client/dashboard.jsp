...
<div id="dashboard-admin-client">
  ...
  <div class="row liste-filial">
      <c:forEach var="sb" items="${subsdiaries}">
        <div  id='${sb.id}' class="col-3 item-filial">
         <div class="card d-block">
          ...
          <p class="text-muted font-13 mb-3"><span class="label-adresse"><c:out value="${sb.adresse}"/></span> - <span class="label-contact"><c:out value="${sb.numTel}"/></span>
          </p>
          <!-- project detail-->
          <p class="mb-1">
