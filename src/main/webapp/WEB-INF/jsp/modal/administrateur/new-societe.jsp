    ...
    <form class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="mb-1">
          ...
          <input name="inputUsername" type="text" id="input-username" class="form-control">
        </div>
        <div class="mb-1">
          <label for="input-password" class="form-label">Mot de passe</label>
          <input name="inputPassword" type="password" id="input-password" class="form-control">
        </div>
        <div class="mb-1">
          <div class="row">
            <div class="col-6">
              <label for="input-slogan-i" class="form-label">Slogan I</label>
              <input name="inputSloganI" type="text" id="input-slogan-i" class="form-control">
            </div>
            <div class="col-6">
              <label for="input-slogan-ii" class="form-label">Slogan II</label>
              <input name="inputSloganII" type="text" id="input-slogan-ii" class="form-control">
            </div>
          </div>
        ...
        <div class="mb-1 pt-1">
          <div class="row">
            <div class="col-12">
              ...
              <input type="file" name="logo" id="input-logo" class="form-control pt-1">
            </div>
          </div>
        </div>
