    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="mb-3">
          ...
          <input name="nomCategorie" type="text" id="nom-magasin" class="form-control">
        </div>
        <div class="mb-3">
          <label for="adresse-magasin" class="form-label">Adresse du magasin</label>
          <input name="nomCategorie" type="text" id="adresse-magasin" class="form-control">
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Annuler</button>
        <button id="btn-enregistrer-magasin" data-bs-dismiss="modal" type="button" class="btn btn-primary">Enregistrer
        </button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
