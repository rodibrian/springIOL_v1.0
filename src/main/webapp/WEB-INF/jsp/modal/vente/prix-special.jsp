...
<!-- Small modal -->
<div class="modal fade" id="modal-prix-special" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="number" id="input-prix-special" class="form-control" placeholder="Entrer le prix sp&eacute;cial" aria-label="Recipient's username">
            </div>
