...
<div class="modal fade" id="bs-example-modal-lg2" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg h-50">
        <div class="modal-content bg-light text-dark">
            ...
            <div class="mb-3">
    <input type="text" id="example-input-large" name="example-input-large" class="form-control w-100 d-block" placeholder="article à recherché">
</div>
            <hr>
                <table id="basic-datatable" class="table table-hover table-sm dt-responsive nowrap w-100">
    <thead>
        <tr>
            <th>Nom & Prenoms</th>
            <th>Adresse</th>
