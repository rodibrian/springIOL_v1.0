<!-- Standard modal -->
<div id="new-chauffeur" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <div class="mb-1">
                            <label for="nomEtPrenoms" class="form-label">Nom & prenoms</label>
                             <input name="nomEtPrenoms" type="text" id="nomEtPrenoms" class="form-control">
                        </div>
                      <div class="mb-1">
