        ...
        <div class="row">
          <div class="col-6 d-flex justify-content-center">
            <address class="m-t-5 m-b-5">
              ...
              <strong class="label-adresse-societe">(Adresse)</strong><br>
              <strong class="label-ville">(Ville)</strong><br>
              Tel : <strong class="label-contact">(Contact)</strong><br>
          ...
          <div class="col-6 d-flex justify-content-center">
            <address class="m-t-5 m-b-5">
              ...
              <br>
              Op : <span class="label-utilisateur">(Nom de l'opérateur)</span><br>
            </address>
          </div>
        </div>
      </div>
