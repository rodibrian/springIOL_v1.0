    ...
    <form class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="mb-1">
          ...
          <input name="typeMateriel" type="text" id="type-materiel" class="form-control">
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Annuler</button>
        <button id="btn-enregistrer-materiel-de-transport" type="submit" class="btn btn-primary">Enregistrer</button>
      </div>
    </form><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div>
