        ...
        <div class="mb-0">
          <div class="row">
            <div class="col-md-6">
              ...
              <input name="adresse" type="text" id="adresse" class="form-control form-control-sm">
            </div>
            <div class="col-md-6">
              <label for="ville" class="form-label">VIlle</label>
              <input name="ville" type="text" id="ville" class="form-control form-control-sm">
            </div>
          </div>
        </div>
        <div class="mb-0">
        ...
        <div class="mb-0">
          <div class="row">
            <div class="col-md-6">
              ...
              <input name="nif" type="text" id="nif" class="form-control form-control-sm">
            </div>
            <div class="col-md-6">
              <label for="stat" class="form-label">STAT</label>
              <input name="stat" type="text" id="stat" class="form-control form-control-sm">
            </div>
          </div>
        </div>
