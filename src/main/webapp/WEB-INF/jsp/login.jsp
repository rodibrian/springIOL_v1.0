        ...
        <div class="card">
          ...
          <div class="card-header pt-4 pb-4 text-center bg-primary text-light">
            <a class="text-dark fw-bold" href="#">
              <span><img src="${pageContext.request.contextPath}/assets/images/logo.png" alt="" height="18">&nbsp; I-jeery OnLine</span>
            </a>
          </div>
          ...
          <div class="card-body p-4">
            ...
            <form action="signup" method="post">
              ...
              <div class="mb-3">
                ...
                <input name="username" class="form-control" type="text" id="emailaddress" required="" placeholder="Entrer votre nom d'utilisateur">
              </div>
