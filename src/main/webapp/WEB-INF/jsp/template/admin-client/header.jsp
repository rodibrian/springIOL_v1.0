              ...
              <ul class="navbar-nav">
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-dashboards"
                     ...
                     aria-expanded="false">
                    <i class="uil-dashboard me-1"></i>Tableau de bord societe
                    <div class="arrow-down"></div>
                  </a>
                  <div class="dropdown-menu" aria-labelledby="topnav-dashboards">
                    <a href="#" class="dropdown-item">Chiffre d'affaire</a>
                    <a href="#" class="dropdown-item">Autres statistiques</a>
                  </div>
                </li>
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle arrow-none" href="#" id="-topnav-dashboards"
                     role="button" data-bs-toggle="dropdown" aria-haspopup="true"
                     aria-expanded="false">
                    <i class="uil-dashboard me-1"></i>Gérer societe
                    <div class="arrow-down"></div>
                  </a>
                  <div class="dropdown-menu" aria-labelledby="---topnav-dashboards">
                    <a href="#" class="dropdown-item">information societe</a>
                  </div>
                </li>
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle arrow-none" href="#" id="----topnav-dashboards"
                     role="button" data-bs-toggle="dropdown" aria-haspopup="true"
                     aria-expanded="false">
                    <i class="uil-dashboard me-1"></i>A propos
                    <div class="arrow-down"></div>
                  </a>
                  <div class="dropdown-menu" aria-labelledby="topnav-dashboards">
                    <a href="#" class="dropdown-item">A propos du societe</a>
                  </div>
                </li>
