...
<div class="row d-flex justify-content-center align-items-center bg-ligth" id="menu-vente" data-plugin="dragula">
  <div class="col-md-11">
    <div class="card mt-3 mb-3">
      <form class="card-body bg-light text-dark">
            ...
            <div class="col-lg-5">
              ...
              <div class="mb-1">
                ...
                <div class="input-group">
                  <input id="name-client" type="text" name="nameClient" class="form-control" placeholder="Nom du client"
              ...
              <div class="mt-1 d-inline-flex d-none">
                <div class="form-check">
                  <input name="checkBox" type="checkbox" class="form-check-input" id="check-bon">
                  <label class="form-check-label" for="check-bon">Bon</label>
                </div>&nbsp;&nbsp;&nbsp;
                <div class="form-check ml-1">
                  <input name="checkALivrer" type="checkbox" class="form-check-input" id="check-a-livrer">
              ...
              <div class="mb-1">
                ...
                <div class="input-group">
                  <input type="text" name="designation" class="form-control" placeholder="Nom de l'article"
              ...
              <div class="row g-2">
                <div class="mb-1 col-md-6">
                  ...
                  <input type="number" name="inputQuantiteArticle" class="form-control" id="input-quantite-article" placeholder="00">
                </div>
                <div class="mb-1 col-md-6">
                  <label for="input-unite-article" class="form-label">Unite</label>
                  <select name="inputUniteArticle" class="form-select" id="input-unite-article">
                  </select>
                </div>
              </div>
              <div class="mb-1">
                ...
                <div class="input-group">
                  <input id="input-prix-unitaire" type="text" name="inputPrixUnitaire" class="form-control" value="0"
                         aria-label="Recipient's username">
