...
<!-- vente content -->
    ...
    <select class="form-select" id="example-select">
        ...
        <div class="input-group">
            ...
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#bs-example-modal-lg2"><i class="uil-search"></i></button>
        </div>
    </div>
...
<div class="mb-1">
        ...
        <div class="input-group">
            <input type="text" class="form-control" placeholder="Nom de l'article" aria-label="Recipient's username">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#bs-example-modal-lg"><i class="uil-search"></i></button>
        </div>
    </div>
    ...
    <div class="mb-1">
        ...
        <div class="input-group">
            ...
            <button  type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#bs-example-modal-sm">Prix sp�cial</button>
        </div>
    </div>
